...
class UsersController extends Controller
{
    ...
    {
        $parents = User::all();
        return view('modules.users.create', compact('parents'));
    }
    /**
    ...
    public function getProfile()
    {
        ...
        return view('modules.users.profile.view', compact('user'));
    }
    public function getEditProfile()
    {
        $user = User::findOrFail(Auth::user()->id);
        return view('modules.users.profile.edit', compact('user'));
    }
