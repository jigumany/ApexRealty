                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="w-full">
                                <form action="/admin/users/store/{{ $user->id }}" method="POST" class="user-form">
                                    @csrf
                                    ...
                                    <input value="{{ $user->phone }}" placeholder="Phone" class="mb-3 shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="phone" id="phone">
